...
namespace QLWebsite.Areas.Admin.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,LoaiSP,TenSP,GiaBan,DanhMuc,SLTon,NhaSanXuat,NgayCapNhat,MoTa,HinhAnh")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,LoaiSP,TenSP,GiaBan,DanhMuc,SLTon,NhaSanXuat,NgayCapNhat,MoTa,HinhAnh")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
